## WinPython 3.4.3.6Qt5

The following packages are included in WinPython v3.4.3.6Qt5.
...
[baresql](http://pypi.python.org/pypi/baresql) | 0.7.2 | playing SQL directly on Python datas
[bcolz](http://pypi.python.org/pypi/bcolz) | 0.11.4 | columnar and compressed data containers.
...
[cffi](http://pypi.python.org/pypi/cffi) | 1.3.0 | Foreign Function Interface for Python calling C code.
...
[guidata](http://packages.python.org/guidata) | 1.7.0b6 | Automatically generated graphical user interfaces for easy data set edition and display
[guiqwt](http://packages.python.org/guiqwt) | 3.0.0b7 | Efficient curve/image plotting and other GUI tools for scientific data processing software development
...
[joblib](http://pypi.python.org/pypi/joblib) | 0.9.2 | Lightweight pipelining: using Python functions as pipeline jobs.
...
[lmfit](http://pypi.python.org/pypi/lmfit) | 0.9.1 | Least-Squares Minimization with Bounds and Constraints
...
[matplotlib](http://pypi.python.org/pypi/matplotlib) | 1.5.0rc3 | 2D plotting library (embeddable in GUIs created with PyQt)
...
[numexpr](http://pypi.python.org/pypi/numexpr) | 2.4.4 | Fast evaluation of array expressions elementwise by using a vector-based virtual machine
...
[pytz](http://pypi.python.org/pypi/pytz) | 2015.6 | World Timezone Definitions for Python
...
[rpy2](http://pypi.python.org/pypi/rpy2) | 2.7.2 | Python interface to the R language (embedded R)
...
[scikit-learn](http://pypi.python.org/pypi/scikit-learn) | 0.16.1 | A set of Python modules for machine learning and data mining
...
[setuptools](http://pypi.python.org/pypi/setuptools) | 18.4 | Download, build, install, upgrade, and uninstall Python packages - easily
...
[sqlparse](http://pypi.python.org/pypi/sqlparse) | 0.1.16 | Non-validating SQL parser
...
[twine](http://pypi.python.org/pypi/twine) | 1.6.3 | Collection of utilities for interacting with PyPI
...
The following packages are included in WinPython v3.4.3.6.
