## History of changes for WinPython 2.7.10.2
...
## History of changes for WinPython 2.7.9.5
...
Upgraded packages: 
  ...
  * [cx_Freeze](http://cx-freeze.sourceforge.net) 4.3 → 4.3.1 (Deployment tool which converts Python scripts into stand-alone Windows executables (i.e. target machine does not require Python or any other library to be installed)) 
