...
New packages:
  ...
  * [rpy2](http://pypi.python.org/pypi/rpy2) 2.4.3 (Python interface to the R language (embedded R))

  * [scilab2py](http://pypi.python.org/pypi/scilab2py) 0.4 (Python to Scilab bridge)
  ...
  * [sqlparse](http://pypi.python.org/pypi/sqlparse) 0.1.12 (Non-validating SQL parser)
...
Upgraded packages:
  ...
  * [Pillow](http://pypi.python.org/pypi/Pillow) 2.4.0 → 2.6.0 (Python Imaging Library (fork))

  * [PyOpenGL](http://pyopengl.sourceforge.net) 3.1.0b3 → 3.1.0 (Cross platform Python binding to OpenGL and related APIs)

  * [SQLAlchemy](http://www.sqlalchemy.org) 0.9.6 → 0.9.7 (SQL Toolkit and Object Relational Mapper)

  * [Sphinx](http://sphinx.pocoo.org) 1.2.2 → 1.2.3 (Tool for generating documentation which uses reStructuredText as its markup language)

  * [astroid](http://pypi.python.org/pypi/astroid) 1.1.1 → 1.2.1 (Rebuild a new abstract syntax tree from Python's ast (required for pylint))

  * [colorama](http://pypi.python.org/pypi/colorama) 0.3.1 → 0.3.2 (Cross-platform colored terminal text)

  * [docutils](http://docutils.sourceforge.net) 0.11 → 0.12 (Text processing system for processing plaintext documentation into useful formats, such as HTML or LaTeX (includes reStructuredText))

  * [ipython](http://ipython.org) 2.1.0 → 2.3.0 (Enhanced Python shell)

  * [logilab-common](http://pypi.python.org/pypi/logilab-common) 0.61.0 → 0.62.1 (Collection of low-level Python packages and modules used by Logilab projects (required for pylint))

  * [mahotas](http://pypi.python.org/pypi/mahotas) 1.1.0 → 1.2.1 (Computer Vision library)
  ...
  * [pylint](http://www.logilab.org/project/pylint) 1.2.1 → 1.3.1 (Logilab code analysis module: analyzes Python source code looking for bugs and signs of poor quality)

  * [pytz](http://pytz.sourceforge.net/) 2014.4 → 2014.7 (World Timezone Definitions for Python)

  * [scikit-image](http://pypi.python.org/pypi/scikit-image) 0.10.0 → 0.10.1 (Image processing toolbox for SciPy)

  * [scikit-learn](http://pypi.python.org/pypi/scikit-learn) 0.15.0b1 → 0.15.2 (A set of Python modules for machine learning and data mining)

  * [setuptools](http://pypi.python.org/pypi/setuptools) 3.8.1 → 5.8 (Download, build, install, upgrade, and uninstall Python packages - easily)

  * [simplejson](http://pypi.python.org/pypi/simplejson) 3.5.2 → 3.6.4 (Simple, fast, extensible JSON (JavaScript Object Notation) encoder/decoder)

  * [six](http://pypi.python.org/pypi/six) 1.7.2 → 1.8.0 (Python 2 and 3 compatibility utilities)

  * [spyder](https://bitbucket.org/spyder-ide/spyderlib) 2.3.0 → 2.3.1 (Scientific PYthon Development EnviRonment: designed for interactive computing and data visualisation with a simple and intuitive user interface)

  * [tornado](http://pypi.python.org/pypi/tornado) 3.2.2 → 4.0.2 (Scalable, non-blocking web server and tools (required for IPython notebook))
